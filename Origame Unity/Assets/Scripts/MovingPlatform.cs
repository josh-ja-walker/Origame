...
public class MovingPlatform : Activatable
{
    ...
    private void FixedUpdate() {
        ...
        if (isMoving) {
            ...
            carryCols = Physics2D.OverlapBoxAll((Vector2) transform.position + carryCheckOffset, carryCheckSize, transform.eulerAngles.z, carryLayers);
